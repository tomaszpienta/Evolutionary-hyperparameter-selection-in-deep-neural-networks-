...
class Dataloader:
    ...
    def __init__(self):
        ...
        self.data_dir = './Loadset/Salinas/data/'

        self.name = 'salinas'

        self.image_shape = (512, 217, 204)
        self.image = ()
    ...
    def get_image(self, verbal=True):
        ...
        filename = 'Salinas_corrected.mat'
        ImDict = io.loadmat(self.data_dir + filename)
        image_name = 'salinas_corrected'
    ...
    def get_labels(self, verbal=True):
        if verbal:
            ...
            # To juz jest w uint8
        filename_labels = 'Salinas_gt.mat'
        ImDict_labels = io.loadmat(self.data_dir + filename_labels)
        image_name_labels = 'salinas_gt'
