...
class Dataloader:
    ...
    # self.data_dir = 'C:/Users/Public/AI/artificial-intelligence---my-beginning/venv/data/Pavia/'
        self.data_dir = './Loadset/Botswana/data/'
        if not os.path.exists(self.data_dir):
            self.data_dir = 'Botswana/data/'




        self.image_shape = (1476 , 256, 145)
        self.image = ()
        self.image_list = ()
        self.image_labels = ()
    ...
    def get_labels(self, verbal=True):
        if verbal:
            ...
            # To juz jest w uint8
        filename_labels = 'Botswana_gt.mat'
        ImDict_labels = io.loadmat(self.data_dir + filename_labels)
        image_name_labels = 'Botswana_gt'
